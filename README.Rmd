...
<!-- badges: start -->
![](https://github.com/UBC-MDS/PrepR/workflows/build/badge.svg) [![codecov](https://codecov.io/gh/UBC-MDS/PrepR/branch/master/graph/badge.svg)](https://codecov.io/gh/UBC-MDS/PrepR) ![Release](https://github.com/UBC-MDS/PrepR/workflows/Release/badge.svg)  

[![Documentation Status](https://readthedocs.org/projects/PrepR/badge/?version=latest)](https://PrepR.readthedocs.io/en/latest/?badge=latest)
<!-- badges: end -->
...
We were unable to find any packages that do everything that ours does, but there are packages for machine learning in R that we will make use of. 
...
The `caret` package also does one-hot encoding with the function `dummyVars`, though we aim to have a function that's more intuitive.
Overall, we feel this package will fit in well with the R ecosystem and help make machine learning a little easier. 
...
### Credits
This package was created using the the [Whole Game Chapter](https://r-pkgs.org/whole-game.html) from the [R Packages](https://r-pkgs.org/) handbook by Hadley Wickham
